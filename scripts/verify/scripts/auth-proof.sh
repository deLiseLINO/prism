...
EVID_FINAL="${PRISM_VERIFY_EVIDENCE_DIR:-$REPO_ROOT/scripts/verify/evidence/auth-proof/$RUN_ID}"
...
node "$REPO_ROOT/scripts/verify/scripts/cdp-screenshot.mjs" "$WS" "$EVID_WORK/auth-codex-pending.png"
...
node "$REPO_ROOT/scripts/verify/scripts/cdp-screenshot.mjs" "$WS" "$EVID_WORK/auth-antigravity-pending.png"
...
node "$REPO_ROOT/scripts/verify/scripts/cdp-screenshot.mjs" "$WS" "$EVID_WORK/auth-after-cancel.png"
