...
run_local_steps() {
  ...
  run_step "prismd-smoke.sh" bash "$repo/scripts/verify/scripts/prismd-smoke.sh"
  run_step "prismctl-proof.sh" bash "$repo/scripts/verify/scripts/prismctl-proof.sh"
  run_step "desktop-controls.sh" bash "$repo/scripts/verify/scripts/desktop-controls.sh"
  run_step "api-sweep.sh" bash "$repo/scripts/verify/scripts/api-sweep.sh"
  run_step "integration-drive.sh" env PRISM_VERIFY_LIVE=0 bash "$repo/scripts/verify/scripts/integration-drive.sh"
}
...
run_live_steps() {
  run_step "auth-proof.sh" bash "$repo/scripts/verify/scripts/auth-proof.sh"
  run_step "quota-proof.sh" bash "$repo/scripts/verify/scripts/quota-proof.sh"
  run_step "integration-drive.sh (live)" env PRISM_VERIFY_LIVE=1 bash "$repo/scripts/verify/scripts/integration-drive.sh"
  run_step "live-matrix.sh" bash "$repo/scripts/verify/scripts/live-matrix.sh"
}
