...
node "$REPO_ROOT/scripts/verify/scripts/cdp-screenshot.mjs" "$WS" "$EVID_WORK/machines-added.png"
...
node "$REPO_ROOT/scripts/verify/scripts/cdp-screenshot.mjs" "$WS" "$EVID_WORK/machines-removed.png"
