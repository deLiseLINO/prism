...
function IntegrationCard({ status, agent, index, bulkBusy, onChanged }: IntegrationCardProps): JSX.Element {

  const applyTask = useTask()
  const rollbackTask = useTask()
  const busy = applyTask.running || rollbackTask.running || bulkBusy
...
function IntegrationsBoard({ list, byAgent, onChanged }: IntegrationsBoardProps): JSX.Element {
