...
EVID_FINAL="${PRISM_VERIFY_EVIDENCE_DIR:-$REPO_ROOT/scripts/verify/evidence/quota-proof/$RUN_ID}"
...
node "$REPO_ROOT/scripts/verify/scripts/cdp-screenshot.mjs" "$WS" "$EVID_WORK/accounts.png"
